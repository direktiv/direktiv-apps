...
// Defaults
const (
	code             = "com.aws-ec2-start.error"
	AWS_CLI_TEMPLATE = ` ec2 start-instances 
	--instance-ids {{.InstanceID}}`
)

func main() {
	direktivapps.StartServer(AWSInstanceStart)
}

func AWSInstanceStart(w http.ResponseWriter, r *http.Request) {
	var err error
